...
<body>
  ...
  <s:if test="exceptionMessage!=null">
    ...
    <div class="evaluateTableHead" id="headid">
     ...
     <form action="/EvaluateSystem/front/createZJEvaluateFrontEvaluateZJAction.action" method="post" id="signupForm" onsubmit="return buttonSubmit();">
    	助教姓名:	<input type="text" name="zjevaluate.assistant.assistantName" value="<s:property value="zjevaluate.assistant.assistantName"/>" readonly="readonly"/>
    	班级:<input type="text" name="zjevaluate.clazz" value="<s:property value="zjevaluate.clazz"/>" readonly="readonly"/>
    	课程:<input type="text" name="zjevaluate.subject" value="<s:property value="zjevaluate.subject"/>" readonly="readonly" size="10"/>
    ...
    <div class="fieldContainer" id="headDiv">
      ...
      <div class="formRow">
     	...
     	<table width=100% align=center  bordercolor='black' cellspacing='0' frame="void">
						...
						评分标准:<br>
						☆&nbsp;&nbsp;&nbsp;很好:&nbsp;该助教在该项工作很好,作为学员的你较为满意<br>
						☆&nbsp;&nbsp;&nbsp;好　:&nbsp;该助教在该项基本达到你的预期,但明显有提高的必要<br>
						☆&nbsp;&nbsp;&nbsp;一般:&nbsp;该助教在该项上勉强合格,距离优秀还有极大的差距<br>
						☆&nbsp;&nbsp;&nbsp;差　:&nbsp;该助教在该项上基本不合格,难以满足你的要求<BR>
						☆&nbsp;&nbsp;&nbsp;很差:&nbsp;该助教在该项上完全不合格,无法胜任目前的教学工作,你已难以忍受</h4></th>
					</tr>
    	...
    	<input type="text" name="zjevaluateDetail.zjevaluateId" value="<s:property value="zjevaluate.id"/>" style="display: none;"/>
