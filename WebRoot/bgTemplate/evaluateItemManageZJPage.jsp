...
<body>
					...
					.datagrid(
							{
								...
								striped : true,
								collapsible : true,
								url : 'EvaluateSystem/EvaluateItemZJ_showZJEvaluateItems.action',
								loadMsg : '数据装载中......',
								...
								columns : [ [ /*{
										...
										},
										{
											...
											formatter : function(value, value1) {
												...
												return "<a href=\"errorZJ.jsp?evaluateItemStatu="
								...
								toolbar : [
										{
											...
											$.messager.confirm('确定', '确定删除?', function(r){
												...
												if (str.indexOf("n", 0) >= 0) {
													$.messager.alert('提示',"被选中的助教教评项已经被使用，不能删除！",'info');
												} else {
													var str2 = "";
													for ( var i = 0; i < rows.length; i++) {
														ids.push(rows[i].id);
													...
													location.href = "EvaluateItemZJ_removeZJEvaluateItem.action?removeItem="
															+ str2;
											}}});
	...
	<table style="width: 100%">
		<tr>
			<td style="width: 10%">添加助教教评项：</td>
			<td style="width: 50%"><a id="creataEvaluateItem"
				href="<%=request.getContextPath()%>/bgTemplate/evaluateItemCreateZJPage.jsp"
				class="easyui-linkbutton" icon="icon-add">创建助教教评项</a>
			</td>
