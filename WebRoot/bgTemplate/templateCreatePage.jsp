...
<script type="text/javascript">
                                                		function tosubmit(f) {
                                                			...
                                                			if($("#inteachers>option").length != 8){
                                                				$.messager.alert('提示',"勾选项必须选8项",'info');
                                                				return false;
                                                			}
                                                			if($("#inteachers2>option").length != 2){
                                                				$.messager.alert('提示',"建议项必须选2项",'info');
                                                				return false;
                                                			}
                                                			var s = f['inteachers'];
...
<body>
	...
	<div style="margin-left:100px;margin-top:20px">
		<div class="easyui-panel" title="创建教师教评模板"
										...
										<div class="art-content-layout-row">
											<div class="art-layout-cell layout-item-2"
												...
												<div id="d1">
													<div id="d1_body">
														<form id="f1"
															action="<s:url action='Template_createTemplate.action'/>"
															...
															<table style="width:100%;">
																...
																<tr>
																	...
																	<a href="templateManagePage.jsp" class="easyui-linkbutton" icon="icon-back" onclick="clearForm()">返回上一页</a>
																	</td>
																</tr>
															</table>
														</form>
