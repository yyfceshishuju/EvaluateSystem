...
<body>
	<div style="margin-left:300px;margin-top:50px">
		<div class="easyui-panel" title="创建助教教评项"
			style="width:500px;heigth:500px">
			<div style="padding:10px 0 10px 60px">
				<form id="ff" method="post"
					action='<s:url action='EvaluateItemZJ_createZJEvaluateItem.action'></s:url>'>
					<table>
						<tr>
							<td>教评项名称:</td>
							<td><input class="easyui-validatebox" type="text"
								name="itemName" data-options="required:true"></input><span style="color:red;">*字符不能超过10</span>
							</td>
						</tr>
						<tr>
							<td>教评项分值:</td>
							<td><input id="itemScore" class="easyui-validatebox"
								type="text" name="itemScore"
			...
			<div style="text-align:center;padding:5px">
				<a href="javascript:void(0)" class="easyui-linkbutton"
					icon="icon-ok" onclick="submitForm()">添加助教教评项</a> <a
