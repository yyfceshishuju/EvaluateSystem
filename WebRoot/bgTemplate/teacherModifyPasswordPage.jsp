...
<body>
	<div style="margin-left:300px;margin-top:50px">
		<div class="easyui-panel" title="讲师修改密码"
			style="width:500px;heigth:500px">
			<div style="padding:10px 0 10px 60px">
				<form id="ff" method="post"
					action='<s:url namespace="/bgTemplate" action='Admin_teacherModifyPassword.action'></s:url>'>
					<table>
						<tr>
							<td>原始密码:</td>
							<td><input class="easyui-validatebox" type="password"
								name="oldPassword" data-options="required:true"></input><span
						...
						<tr>
							...
							<td><input id="itemScore" class="easyui-validatebox"
								type="password" name="newPassword1" data-options="required:true"></input><span
