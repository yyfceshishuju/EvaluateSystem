...
<body>
	...
	<script type="text/javascript">
		function callback(){
			...
			location.href="<%=request.getContextPath()%>/bk/evaluateDetails.jsp?id="+eid+"&templateId="+tempId+"&clazz="+clazz;
		}
	</script>
	<input id="tempId" type="hidden" value="${param.templateId}"/>
	<input id="clazz" type="hidden" value="<s:property value="clazz"/>"/>
