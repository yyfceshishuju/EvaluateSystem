...
<div align="center">
	<div style="margin:10px 0px"></div>
		...
		<form id="ff" action="<%=request.getContextPath()%>/evaluate/evaluate_createEvaluate.action" method="POST">
	    	<table>
	    		<tr>
	    			<td>讲师姓名:</td>
	    			<td><select class="easyui-combobox" name="teacherId" data-options="required:true">
	    		...
	    		<tr>
	    			<td>科       目:</td>
	    			<td><input id="subject" class="easyui-validatebox" type="text" name="evaluate.subject" data-options="required:true"></input></td>
	    		</tr>
	    		<tr>
	    			<td>班     级:</td>
	    			<td><input id="clazz" class="easyui-numberbox" type="text" name="evaluate.clazz" data-options="required:true"></input><span style="">只能输入数字</span>
	    			</td>
	    		</tr>
	    		<tr>
	    			<td>班级总人数:</td>
	    			<td><input id="clazzCount" class="easyui-numberbox" type="text" name="evaluate.clazzCount" data-options="required:true"></input><span style="">只能输入数字</span></td>
	    		</tr>
	    		<tr>
	    			<td>班级实际人数:</td>
	    			<td><input id="realCount" class="easyui-numberbox" type="text" name="evaluate.realCount" data-options="required:true"></input><span style="">只能输入数字</span></td>
	    		</tr>
	    		<tr>
	    			<td>请选择教评模板:</td>
	    		...
	    		<tr>
	    			<td>开始时间:</td>
	    			<td><input id="bd" class="easyui-datebox" name="evaluate.beginDate" required data-options="validType:'md[\'10/11/2012\']'"></input>
</td>
	    		</tr>
	    		<tr>
	    			<td>结束时间:</td>
	    			<td>
	    				<input id="ed" class="easyui-datebox" name="evaluate.endDate" required data-options="validType:'md[\'10/11/2012\']'"></input>
	    			</td>
	    		</tr>
	    		<tr>
    			<td>状态</td>
