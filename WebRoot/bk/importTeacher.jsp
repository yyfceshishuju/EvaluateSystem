 ...
 <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/themes/default/easyui.css">
  ...
  <div style="margin:10px 0px;" align="center">
	<div class="easyui-panel" title="教评结果上传" style="width:500px">
		 <form id="ff" action="<%=request.getContextPath() %>/importData/importTeachers.action" method="post" enctype="multipart/form-data">    	
    	<div style="padding:20px 20px"> 
    		...
    		选择上传教评信息的excel表:<input class="fileName" type="file" name="upload" value="请选择"/><br/><br/><br/>
    		选择上传教评详细信息的excel表:<input class="fileName" type="file" name="upload" value="请选择"/><br/><br/>
   		</div>
    </form>
	</div>
	<div align="center">
